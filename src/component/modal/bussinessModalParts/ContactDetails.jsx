    ...
    return (
        <>
            ...
            <span className="flex gap-5 my-2">
                ...
                <input type="text" placeholder="Facebook Link" className="w-full h-[2rem] border rounded-md border-gray-400 bg-gray-100 ps-4" onChange={(e) => dispatch(addDetails({ facebookLink: e.target.value }))} />
            </span>
            <span className="flex gap-5 my-2">
                <span className="h-[2rem] w-[2rem] object-contain">
                ...
                <input type="text" placeholder="Instagram Link" className="w-full h-[2rem] border rounded-md border-gray-400 bg-gray-100 ps-4" onChange={(e) => dispatch(addDetails({ instagramLink: e.target.value }))} />
            </span>
            <span className="flex gap-5 my-2">
                <span className="h-[2rem] w-[2rem] object-contain">
                ...
                <input type="text" placeholder="Youtube Link" className="w-full h-[2rem] border rounded-md border-gray-400 bg-gray-100 ps-4" onChange={(e) => dispatch(addDetails({ youtubeLink: e.target.value }))} />
            </span>
            <span className="flex gap-5 my-2">
                <span className="h-[2rem] w-[2rem] object-contain">
                    <svg
                ...
                <input type="text" placeholder="XLink" className="w-full h-[2rem] border rounded-md border-gray-400 bg-gray-100 ps-4" onChange={(e) => dispatch(addDetails({ xLink: e.target.value }))} />
            </span>
            <div className="w-full border-[1px] border-gray-200"></div>
            {
